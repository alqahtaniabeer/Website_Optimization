...
// Move this out of a loop because it will select the same element in every iteration
...
function updatePositions() {
  ...
  for (i = 0; i < 5; i++){
    ...
    var scroll = Math.sin((scrollPosition) + i );
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // calculating he number of required pizzas
  height = window.screen.height;
  var rows = height / s;
  requiredPizzas = rows * cols;
